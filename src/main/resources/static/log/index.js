$(document).ready(function() {
    ...
    $.get('/api/server/status', function(data) {
        ...
        container.append('<div class="status-item">Games created: ' + data.gameCreated + '</div>');
        container.append('<div class="status-item">Games started: ' + data.gameStarted + '</div>');
        container.append('<div class="status-item">Games finished: ' + data.gameFinished + '</div>');
        ...
        container.append('<div class="status-item">Draws ' + data.draw + '</div>');
    });
